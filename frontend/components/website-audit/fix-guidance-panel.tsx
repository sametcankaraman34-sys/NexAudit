...
import type { FixGuidanceItem } from "@/data/mock-website-audit";
...
export function FixGuidancePanel({ items, animationDelay = 0 }: FixGuidancePanelProps) {
  return (
    <section
    ...
    >
      <div className="mb-5 flex items-start gap-3">
        ...
        <div>
          <h2 className="text-base font-semibold text-[var(--text-primary)]">Düzeltme rehberi</h2>
          <p className="mt-0.5 text-sm text-[var(--text-secondary)]">
            NexAudit yalnızca tespit etmez — WordPress ve Elementor içinde nerede düzelteceğinizi gösterir
          </p>
        </div>
      </div>
