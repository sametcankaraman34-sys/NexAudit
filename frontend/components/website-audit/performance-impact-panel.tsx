...
import type { PerformanceFactor } from "@/data/mock-website-audit";
...
interface PerformanceImpactPanelProps {
  factors: PerformanceFactor[];
  animationDelay?: number;
}

export function PerformanceImpactPanel({ factors, animationDelay = 0 }: PerformanceImpactPanelProps) {
      ...
      <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-[var(--text-secondary)]">
            Siteyi yavaşlatan faktörler ve tahmini gecikme
          </p>
        </div>
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 text-xs text-[var(--text-secondary)]">
                <span className="inline-flex items-center gap-1">
                  <Timer className="h-3 w-3" />~{factor.estimatedMs}ms gecikme
                </span>
